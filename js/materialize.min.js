...
//Modales
$('.button,.button2,.button3,.button4,.button5,.button6,.button7,.button8,.button9,.button10,.button11,.button12,.button13,.button14,.button15,.button16').click(function(event){
	event.preventDefault();
  var buttonId = $(this).attr('id');
  $('#modal-container,#modal-container2,#modal-container3,#modal-container4,#modal-container5,#modal-container6,#modal-container7,#modal-container8,#modal-container9,#modal-container10,#modal-container11,#modal-container12,#modal-container13,#modal-container14,#modal-container15,#modal-container16').removeAttr('class').addClass(buttonId);
  $('body').addClass('modal-active');
})

$('#modal-container,#modal-container2,#modal-container3,#modal-container4,#modal-container5,#modal-container6,#modal-container7,#modal-container8,#modal-container9,#modal-container10,#modal-container11,#modal-container12,#modal-container13,#modal-container14,#modal-container15,#modal-container16').click(function(event){
	event.preventDefault();
  $(this).addClass('out');
